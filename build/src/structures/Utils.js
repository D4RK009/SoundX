import { ActionRowBuilder, AttachmentBuilder, ButtonBuilder, EmbedBuilder, StringSelectMenuBuilder, resolvePartialEmoji, REST, Routes } from "discord.js";
...
export default class OrasUtils {
    ...
    async addSlash(cmds){
      ...
      await rest.put(Routes.ApplicationCommands(process.env.CLIENTID), { body: cmds })
    }
}

    ...
    constructor(client) {
        ...
        this.exec = async (message, args, prefix) => {
            ...
            if (args[0].toLowerCase() === `player`) {
                ...
                let b1 = this.client.utils.button(`custom_id`, `SoundX Classic`, 2, `oras_classic_mode`);
                let b2 = this.client.utils.button(`custom_id`, `SoundX x Spotify`, 3, `oras_spotify_mode`);
                let b3 = this.client.utils.button(`custom_id`, `SoundX Simple`, 2, `oras_simple_mode`);
                let b4 = this.client.utils.button(`custom_id`, `SoundX Special`, 1, `oras_special_mode`);
                let b5 = this.client.utils.button(`custom_id`, `No Buttons Style`, 2, `oras_no_mode`);
                let b6 = this.client.utils.button(`custom_id`, `SoundX Old School`, 2, `oras_old_mode`);
            ...
            if (args[0].toLowerCase() === `dj` ||
                ...
                if (args[1].toLowerCase() === `create`) {
                    ...
                    channel.send(`https://cdn.discordapp.com/attachments/1166256471265251451/1169745739740622868/20231101_163723_0000.png?ex=6556859d&is=6544109d&hm=842570c2c30b87f29560bdd115418d14cb243df7eab05cd4b7a27b24672158c6&`);
